...
import MSWW04 from "./static/images/Flora.jpg";
...
export default function MswwPage() {
    ...
    const IMAGES = [
        ...
        { id: 2, title: "B4S",textes: "Application mobile de gestion de la réputation numérique",  label01:" label01",label02:" label02",label03:"label03",
    ...
    techno02: "Laravel : mySQL", color: "DarkOrchid", src:Lima,
        sample00:"John" , sample02:Bison02 , sample03:Bison03 , sample05: "Jones"},
    ...
    */
    ...
    return (
        <Grid style={{ paddinTop:"4em",backgroundColor:"#102D40", color:"white"}}>
            <Grid>
                <div  >
                    <Grid container alignItems="center" style={{paddingLeft:"2em"}} >
                        <Grid container spacing={1} xs={12} lg={12} >
                            <Container>
                             <Grid container  spacing={1}>
                                    <Grid md={5} style={{fontSize:"4em",}} >
                                        {image.title}
                                    </Grid>
                              </Grid>
                            </Container>
                   ...
                   <Grid container>
                    ...
                    <SwipeableViews axis={theme.direction === 'rtl' ? 'x-reverse' : 'x'}
                        ...
                        <TabPanel value={value} index={0} dir={theme.direction}>
                            <Grid container spacing={2} alignItems="center" style={{ height:"40em",
                                backgroundImage:`url(${image.sample01})`, backgroundSize: "cover",
                                }}>

                            <Grid container md={6} lg={6} xs={12}
                                  style={{fontSize:"2em",padding:"1em"}}>
                                <h1>{image.textes}</h1>
                                {image.texte01}
                            </Grid>
                                <Grid container md={4} lg={6} xs={12} style={{fontSize:"2em",padding:"3em"}}>
                                </Grid>
                            </Grid>
                        </TabPanel>
                        ...
                        <TabPanel value={value} index={2} dir={theme.direction}>
                            <Container>
                                <Grid item xs={12} sm={12} container direction="row" >
                                    ...
                                    <Grid xs={12} sm={3} style={{padding:"1em", height:"15em", margin:"1em",backgroundImage: `url(${image.sample03})`, backgroundSize: "cover"}}>
                                        <h3> </h3>
                                        <p></p>
                                    </Grid>

                                    <Grid xs={12} sm={4} style={{padding:"1em", height:"15em", margin:"1em",backgroundImage: `url(${image.sample04})`, backgroundSize: "cover"}}>
                                        <h3> </h3>
                                        <p></p>
                                    </Grid>
                                    ...
                                    <Grid xs={12} sm={3} style={{padding:"1em", height:"15em", margin:"1em", backgroundImage: `url(${image.sample04})`, backgroundSize: "cover"}}>
                                        <h3> </h3>
                                        <p></p>
                                    </Grid>
                                </Grid>
