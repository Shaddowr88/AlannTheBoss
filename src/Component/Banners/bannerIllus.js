...
function BannerIll() {
    ...
    return (
        <div class="container" onMouseMove={({ clientX: x, clientY: y }) => set({ xy: calc(x, y) })}>
            <animated.img className="img" src={INTRO} alt="" style={{position:"absolute", filter: "blur(3px)",boxShadow:"10 px 5px 5px black",
                height: "50em",left: "20em",top:"10em", marginTop:"6em",transform: props.xy.interpolate(trans1)}}/>
